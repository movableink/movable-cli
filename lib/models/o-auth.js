    ...
    return new Promise((resolve, reject) => {
      this.app.use((req, res, next) => {
        ...
        if (uri.pathname === this.callbackPath) {
          ...
          const html = `
<html>
  <title>MDK Login Success</title>
  <body>
    <style>
      body { text-align: center; margin-top: 20vh; font-family: 'Helvetica Neue', Helvetica, sans-serif; font-weight: bold; }
      h1 { font-size: 5.5em; margin-bottom: 0; }
      h2 { font-size: 2.4em; }
    </style>
