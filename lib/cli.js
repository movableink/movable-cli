...
const instrumentation = require("ember-cli/lib/utilities/instrumentation");
...
const logger = require("heimdalljs-logger")("movable-cli:cli/index");
...
function loadCommands() {
  ...
  hash["Serve"] = require("ember-cli/lib/commands/serve");
  hash["Test"] = require("ember-cli/lib/commands/test");
  token.stop();
  return hash;
}
...
function loadTasks() {
  ...
  Object.assign(hash, {
    InstallBlueprint: require("ember-cli/lib/tasks/install-blueprint"),
    NpmInstall: require("ember-cli/lib/tasks/npm-install"),
    CreateAndStepIntoDirectory: require("ember-cli/lib/tasks/create-and-step-into-directory"),
    Test: require("ember-cli/lib/tasks/test"),
    TestServer: require("ember-cli/lib/tasks/test-server")
  });
