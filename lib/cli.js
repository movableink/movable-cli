...
function loadTasks() {
  ...
  hash["InstallBlueprint"] = require("ember-cli/lib/tasks/install-blueprint");
  hash["NpmInstall"] = require("ember-cli/lib/tasks/npm-install");
  hash[
    "CreateAndStepIntoDirectory"
  ] = require("ember-cli/lib/tasks/create-and-step-into-directory");
  hash["Test"] = require("ember-cli/lib/tasks/test");
