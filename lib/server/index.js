...
const productUpdatesApi = require("./product-updates-api");
...
module.exports = function(server, options) {
  ...
  server.use("/dev/app/", express.static(path.join(root, "/app")));
  server.use("/testem.js", (req, res) => {
    res.writeHead(200, { 'Content-Type': 'javascript' });
    res.end('/* dummy file to keep testem happy */');
  });
  ...
  server.use("/api/canvas/help_center/product_updates", productUpdatesApi());
