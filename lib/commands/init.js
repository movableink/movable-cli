...
module.exports = Command.extend({
  name: 'init',
  description: 'Creates a new studio-cli project in the current folder.',
  works: 'everywhere',
  ...
  run(commandOptions, rawArgs) {
    ...
    return this.runTask('InstallBlueprint', blueprintOpts)
      ...
      .then(() => {
        ...
        const message = chalk.yellow(`Studio app successfully created. To start the dev environment, run \`studio serve\` from the app's directory. For more details, use \`studio help\`.`);
