...
class ServeTask extends Task {
  ...
  run(options) {
    ...
    if (builder.legacyConfig) {
      this.ui.writeDeprecateLine("Using legacy rollup build, consider switching this project to build.js");
    }
    ...
    let serverRoot = path.resolve(__dirname, '../server');
